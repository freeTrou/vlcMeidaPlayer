...
QT_MOC_LITERAL(1, 10, 9), // "sig_close"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9) // "onClicked"

    },
    "CTitleBar\0sig_close\0\0onClicked"
};
...
void CTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTitleBar::sig_close)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CTitleBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CTitleBar.data,
    qt_meta_data_CTitleBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
