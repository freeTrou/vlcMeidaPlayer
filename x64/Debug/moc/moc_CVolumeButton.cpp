...
QT_MOC_LITERAL(1, 14, 15), // "sig_VolumeValue"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5) // "value"

    },
    "CVolumeButton\0sig_VolumeValue\0\0value"
};
...
void CVolumeButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CVolumeButton *_t = static_cast<CVolumeButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_VolumeValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CVolumeButton::sig_VolumeValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CVolumeButton::sig_VolumeValue(int _t1)
{
